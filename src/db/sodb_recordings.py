...
class sodb_recordings(Base):
    ...
    sodb_sf_data_id_sf_data = Column(Integer)
    ...
    def __init__(self, primary_performer: object=None,
        ...
        self.sodb_sf_data_id_sf_data=sodb_sf_data_id_sf_data or None
    ...
    def __repr__(self):
        return "<sodb_recordings(primary_performer='%s', other_performers='%s', record_label='%s', date_recorded='%s', medium='%s', sodb_music_id_music='%d', sodb_sf_data_id_sf_data='%d' )>" % (
                             self.primary_performer, self.other_performers, self.record_label, self.date_recorded, self.medium, self.sodb_music_id_music, self.sodb_sf_data_id_sf_data)
